...
CONFIG_CONTROLLER_HOST=10.105.240.143

# List the servers on which to install the Compute service.
CONFIG_COMPUTE_HOSTS=10.105.240.143
...
CONFIG_NETWORK_HOSTS=10.105.240.143
...
CONFIG_STORAGE_HOST=10.105.240.143

# (Unsupported!) Server on which to install OpenStack services
# specific to OpenStack Data Processing (sahara).
CONFIG_SAHARA_HOST=10.105.240.143
...
CONFIG_AMQP_HOST=10.105.240.143
...
CONFIG_KEYSTONE_ADMIN_TOKEN=b12b1acd05134553a8ec38aaebfda329
...
CONFIG_KEYSTONE_ADMIN_PW=a621a9ffcf6d4bfd

# Password to use for the Identity service 'demo' user.
CONFIG_KEYSTONE_DEMO_PW=08bbfd6bb3674df0
...
CONFIG_KEYSTONE_LDAP_URL=ldap://10.105.240.143
...
# database.
CONFIG_GLANCE_DB_PW=d59aaeff9b184fc3

# Password to use for the Image service to authenticate with the
# Identity service.
CONFIG_GLANCE_KS_PW=62ae847d4c4f4c4a
...
# the database.
CONFIG_CINDER_DB_PW=bf6fc695b2d3471d
...
CONFIG_CINDER_KS_PW=37873c6ac95446fb
...
# database.
CONFIG_NOVA_DB_PW=2460ba3ba1b74849

# Password to use for the Compute service to authenticate with the
# Identity service.
CONFIG_NOVA_KS_PW=60635b85591b41af
...
CONFIG_NEUTRON_KS_PW=ca9fe7edf4dc4291

# The password to use for OpenStack Networking to access the
# database.
CONFIG_NEUTRON_DB_PW=8fcd7d2c0c654c1b
...
CONFIG_NEUTRON_METADATA_PW=4265f923406c4d39
...
CONFIG_HORIZON_SECRET_KEY=a0c1e0d520fc4bc1953c9156e9247895
...
# the Identity service.
CONFIG_SWIFT_KS_PW=ff1dc1ea5d1d45e2
...
CONFIG_SWIFT_HASH=4efd597eaf414fe0
...
CONFIG_HEAT_AUTH_ENC_KEY=d6ac895a31d34ae5
...
CONFIG_REDIS_HOST=10.105.240.143
...
# Identity service.
CONFIG_AODH_KS_PW=a927c8ceeb70496f

# Password to use for Telemetry Alarming (AODH) to access the
# database.
CONFIG_AODH_DB_PW=f154087a1a7c457b
